// MFCApplication_TestDoc.cpp: CMFCApplicationTestDoc 클래스의 구현
//
...
#include "CDownSampleDig.h" // 대화상자 사용을 위한 헤더 선언
...
// CMFCApplicationTestDoc 생성/소멸

CMFCApplicationTestDoc::CMFCApplicationTestDoc() noexcept
{
...
// CMFCApplicationTestDoc 명령

BOOL CMFCApplicationTestDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
...
void CMFCApplicationTestDoc::OnDownSampling()
{
	int i, j;
	CDownSampleDig dlg;
...
void CMFCApplicationTestDoc::OnUpSampling()
{
	int i, j;
