...
void CSeungchanView::OnEmbossing()
{
	CSeungchanDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CSeungchanView::OnGaussianFilter()
{
	CSeungchanDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CSeungchanView::OnSharpening()
{
	CSeungchanDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CSeungchanView::OnHpfSharp()
{
	CSeungchanDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CSeungchanView::OnLpfSharp()
{
	CSeungchanDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
