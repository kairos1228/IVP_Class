...
// SeungchanDoc.cpp: CSeungchanDoc 클래스의 구현
//
...
IMPLEMENT_DYNCREATE(CSeungchanDoc, CDocument)

BEGIN_MESSAGE_MAP(CSeungchanDoc, CDocument)
END_MESSAGE_MAP()


// CSeungchanDoc 생성/소멸

CSeungchanDoc::CSeungchanDoc() noexcept
{
	// TODO: 여기에 일회성 생성 코드를 추가합니다.

}

CSeungchanDoc::~CSeungchanDoc()
{
}

BOOL CSeungchanDoc::OnNewDocument()
{
...
// CSeungchanDoc serialization

void CSeungchanDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CSeungchanDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CSeungchanDoc::InitializeSearchContent()
{
...
void CSeungchanDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
#ifdef _DEBUG
void CSeungchanDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CSeungchanDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
BOOL CSeungchanDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
...
void CSeungchanDoc::OnDownSampling()
{
	// TODO: 여기에 구현 코드 추가.
	int i, j;
	CDownSampleDlg dlg;
...
void CSeungchanDoc::OnUpSampling()
{
	// TODO: 여기에 구현 코드 추가.
	int i, j;
...
void CSeungchanDoc::OnQuantization()
{
	// TODO: 여기에 구현 코드 추가.
...
void CSeungchanDoc::OnSumConstant()
{
	// TODO: 여기에 구현 코드 추가.
...
void CSeungchanDoc::OnSubConstant()
{
	// TODO: 여기에 구현 코드 추가.
	CConstantDlg dlg;
...
void CSeungchanDoc::OnMulConstant()
{
	// TODO: 여기에 구현 코드 추가.
	CConstantDlg dlg;
...
void CSeungchanDoc::OnDivConstant()
{
	// TODO: 여기에 구현 코드 추가.
	CConstantDlg dlg;
...
void CSeungchanDoc::OnAndOperate()
{
	// TODO: 여기에 구현 코드 추가.
	CConstantDlg dlg;
	int i;
...
void CSeungchanDoc::OnNegaTransform()
{
	// TODO: 여기에 구현 코드 추가.
	int i;
...
void CSeungchanDoc::OnGammaCorrection()
{
	// TODO: 여기에 구현 코드 추가.
	CConstantDlg dlg;
...
void CSeungchanDoc::OnBinarization()
{
	// TODO: 여기에 구현 코드 추가.
	CConstantDlg dlg;
...
void CSeungchanDoc::OnStressTransform()
{
	// TODO: 여기에 구현 코드 추가.
...
void CSeungchanDoc::OnHistoStretch() //히스토그램 스트레칭
{
	// TODO: 여기에 구현 코드 추가.
	int i;
...
void CSeungchanDoc::OnEndInSearch()
{
	// TODO: 여기에 구현 코드 추가.
	int i;
	unsigned char LOW, HIGH, MAX, MIN;
...
void CSeungchanDoc::OnHistogram() //히스토그램 그래프 출력
{
	// TODO: 여기에 구현 코드 추가.
	// 히스토그램의 값은 0~255
...
void CSeungchanDoc::OnHistoEqual() //히스토그램 평활화
{
	// TODO: 여기에 구현 코드 추가.
	int i, value;
...
void CSeungchanDoc::OnEmbossing()
{
	int i, j;
...
double** CSeungchanDoc::OnMaskProcess(unsigned char* Target, double Mask[3][3])
{ // 회선 처리가 일어나는 함수
	int i, j, n, m;
...
double** CSeungchanDoc::OnScale(double** Target, int height, int width)
{ // 정규화를 위한 함수
	int i, j;
	double min, max;
...
double** CSeungchanDoc::Image2DMem(int height, int width)
{ // 2차원 메모리 할당을 위한 함수
	double** temp;
	int i, j;
...
void CSeungchanDoc::OnGaussianFilter()
{
	int i, j;
...
void CSeungchanDoc::OnSharpening()
{
	int i, j;
...
CSeungchanDoc* CSeungchanView::GetDocument() const
{
	return reinterpret_cast<CSeungchanDoc*>(m_pDocument);
}
